...
console.log("inEquality test with string : ", ("Banana" as string )!= "mango")
...
console.log("Numerical inEquality Test : " ,( 100 as number) != 200)
...
const fruits :string []= ["apple","banana","cherries"]
